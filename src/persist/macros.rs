...
macro_rules! persist_struct {
    ...
    ($vis:vis struct $name:ident table = $table_name:tt { $($field:ident : $field_ty:ty),+ $(,)? }) => {
        $crate::persist_struct!(@impl $vis $name $table_name; $($field : $field_ty),+);
    };
    ($vis:vis struct $name:ident { $($field:ident : $field_ty:ty),+ $(,)? }) => {
        $crate::persist_struct!(
            @impl
            $vis
            $name
    ...
    (@impl $vis:vis $name:ident $table_expr:expr; $($field:ident : $field_ty:ty),+) => {
        $crate::paste::paste! {
