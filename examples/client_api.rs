...
async fn main() -> Result<()> {
    ...
    client
        .execute("INSERT INTO users VALUES (1, 'alice', 'alice@example.com', 30, true)")
        .await?;
    client
        .execute("INSERT INTO users VALUES (2, 'bob', 'bob@example.com', 25, true)")
        .await?;
    client
        .execute("INSERT INTO users VALUES (3, 'charlie', 'charlie@example.com', 35, false)")
        .await?;
    client
        .execute("INSERT INTO users VALUES (4, 'diana', 'diana@example.com', 28, true)")
        .await?;
