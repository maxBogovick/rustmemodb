...
async fn test_recursive_hierarchy() -> anyhow::Result<()> {
    ...
    client.execute("CREATE TABLE employees (id INT, name TEXT, manager_id INT)").await?;
    client.execute("INSERT INTO employees VALUES (1, 'CEO', NULL)").await?;
    client.execute("INSERT INTO employees VALUES (2, 'Manager1', 1)").await?;
    client.execute("INSERT INTO employees VALUES (3, 'Worker1', 2)").await?;
    client.execute("INSERT INTO employees VALUES (4, 'Manager2', 1)").await?;
